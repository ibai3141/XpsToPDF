...
$settings64.XpsToPdf.GhostXpsPath = 'C:\Program Files\XpsToPdfService\GhostXPS\gxpswin64.exe'
...
$settings32.XpsToPdf.GhostXpsPath = 'C:\Program Files\XpsToPdfService\GhostXPS\gxpswin32.exe'
